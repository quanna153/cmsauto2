...
export const marketRows: MarketRow[] = [
  { name: "Bitcoin", symbol: "BTC", price: "$107,240", change: "+2.14%", direction: "up", color: "#111827", bars: ["low", "mid", "low", "up", "up"] },
  { name: "Ethereum", symbol: "ETH", price: "$3,841", change: "+1.87%", direction: "up", color: "#111827", bars: ["mid", "up", "mid", "up", "up"] },
  { name: "BNB", symbol: "BNB", price: "$682", change: "-0.43%", direction: "down", color: "#111827", bars: ["high", "mid", "down", "down", "down"] },
  { name: "Solana", symbol: "SOL", price: "$175.2", change: "+3.21%", direction: "up", color: "#111827", bars: ["low", "mid", "up", "up", "up"] },
  { name: "XRP", symbol: "XRP", price: "$0.618", change: "-1.02%", direction: "down", color: "#111827", bars: ["high", "down", "down", "low", "down"] }
];
