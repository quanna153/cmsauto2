      ...
      <div className="mx-auto max-w-7xl px-5 py-8 md:py-10">
        <section className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_330px]">
          <article className="overflow-hidden rounded-lg border border-[#E5E7EB] bg-white shadow-sm">
            <div className="min-h-[244px] bg-[linear-gradient(135deg,#0F1115,#2B2413_58%,#111827)] p-6 text-white md:p-8">
              ...
              <p className="mt-7 text-xs font-semibold text-[#F5E7B3]">
            ...
            <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
              <p className="max-w-2xl text-sm leading-7 text-[#4B5563]">{featuredLesson.description}</p>
          ...
          <aside className="rounded-lg border border-[#E5E7EB] bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-[#E5E7EB] px-4 py-3">
              <h2 className="inline-flex items-center gap-2 text-sm font-bold">
                <BookOpen size={16} className="text-[#C8A227]" />
        ...
        <section className="mt-10 grid gap-5 lg:grid-cols-[minmax(0,1fr)_330px]">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-7 text-[#4B5563]">{content.taxonomyDescription}</p>
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {content.taxonomy.map((item) => (
                <article className="overflow-hidden rounded-lg border border-[#E5E7EB] bg-white shadow-sm" key={item.title}>
                  <div className={`${taxonomyToneClass[item.tone]} flex min-h-24 items-center justify-between gap-4 px-5 py-5`}>
                    ...
                    <span className="rounded-lg bg-white/70 px-3 py-1 text-xs font-bold">{item.count}</span>
                  </div>
                  <div className="p-5">
          ...
          <aside className="space-y-5">
            <section className="rounded-lg border border-[#E5E7EB] bg-white shadow-sm">
              <div className="flex items-center justify-between border-b border-[#E5E7EB] px-4 py-3">
                ...
                <ListChecks size={16} className="text-[#C8A227]" />
              </div>
              <div className="divide-y divide-[#E5E7EB]">
              ...
              <div className="mt-4 space-y-4">
                {content.glossary.map((item) => (
                  <article key={item.term}>
                    ...
                    <p className="mt-1 text-xs leading-5 text-[#4B5563]">{item.definition}</p>
                  </article>
                ))}
              </div>
            </section>
        ...
        <section className="mt-10 rounded-lg border border-[#E5E7EB] bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between gap-4 border-b border-[#E5E7EB] pb-4">
            ...
            <span className="text-xs font-bold text-[#C8A227]">{content.pathLinkLabel}</span>
          </div>
