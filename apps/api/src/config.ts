...
const envSchema = z.object({
  ...
  IMAGE_GENERATION_PROVIDER: z.string().min(1).optional(),
  IMAGE_GENERATION_MODEL: z.string().min(1).optional(),
  IMAGE_GENERATION_API_KEY: z.string().min(1).optional(),
  IMAGE_GENERATION_PROXY_TOKEN: z.string().min(1).optional(),
  IMAGE_GENERATION_BASE_URL: z.string().url().optional(),
  IMAGE_GENERATION_TIMEOUT_MS: integerString.optional(),
